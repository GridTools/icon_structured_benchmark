...
def run_sanity_checks(
    ...
    if backend in ["all_cpu", "cpu_ifirst"]:
        ...
        (
            p_u_out_cpu_ifirst_unstructured,
            p_v_out_cpu_ifirst_unstructured,
        ...
        assert np.allclose(p_u_out_cpu_ifirst_unstructured, p_u_out_ref)
        assert np.allclose(p_v_out_cpu_ifirst_unstructured, p_v_out_ref)
        print("unstructured cpu_ifirst sanity check passed")

        print("Running structured cpu_ifirst sanity check")
        (
            p_u_out_cpu_ifirst_structured,
            p_v_out_cpu_ifirst_structured,
        ...
        assert np.allclose(p_u_out_cpu_ifirst_structured, p_u_out_ref)
        assert np.allclose(p_v_out_cpu_ifirst_structured, p_v_out_ref)
    ...
    if backend in ["all_cpu", "cpu_kfirst"]:
        ...
        (
            p_u_out_cpu_kfirst_unstructured,
            p_v_out_cpu_kfirst_unstructured,
        ...
        assert np.allclose(p_u_out_cpu_kfirst_unstructured, p_u_out_ref)
        assert np.allclose(p_v_out_cpu_kfirst_unstructured, p_v_out_ref)
        print("unstructured cpu_kfirst sanity check passed")

        print("Running structured cpu_kfirst sanity check")
        (
            p_u_out_cpu_kfirst_structured,
            p_v_out_cpu_kfirst_structured,
        ...
        assert np.allclose(p_u_out_cpu_kfirst_structured, p_u_out_ref)
    ...
    if backend in ["all_gpu", "gpu_kloop"]:
        print("Running unstructured gpu_kloop sanity check")
        (
            p_u_out_gpu_kloop_unstructured,
            p_v_out_gpu_kloop_unstructured,
        ...
        assert np.allclose(p_u_out_gpu_kloop_unstructured, p_u_out_ref)
        assert np.allclose(p_v_out_gpu_kloop_unstructured, p_v_out_ref)
        print("unstructured gpu_kloop sanity check passed")

        print("Running structured gpu_kloop sanity check")
        (
            p_u_out_gpu_kloop_structured,
            p_v_out_gpu_kloop_structured,
        ...
        assert np.allclose(p_u_out_gpu_kloop_structured, p_u_out_ref)
        assert np.allclose(p_v_out_gpu_kloop_structured, p_v_out_ref)
...
def run_benchmarks():
    ...
    if args.backend in ["all_cpu", "cpu_ifirst"]:
        ...
        runtimes[
            "nabla4_interpolate_benchmark_structured_cpu_ifirst"
    ...
    if args.backend in ["all_cpu", "cpu_kfirst"]:
        ...
        runtimes[
            "nabla4_interpolate_benchmark_structured_cpu_kfirst"
