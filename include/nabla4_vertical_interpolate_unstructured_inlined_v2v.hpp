...
struct nabla4_vertical_interpolate_unstructured_inlined_v2v {
    ...
    nabla4_vertical_interpolate_unstructured_inlined_v2v(const std::vector<std::array<index_type, 4>> &e2c2v,
...
static __global__ void __launch_bounds__(block_dims_unstructured_nabla_interpol_inlined_v2v_kloop_vertical.size)
