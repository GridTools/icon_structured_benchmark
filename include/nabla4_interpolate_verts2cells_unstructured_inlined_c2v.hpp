...
__global__ void __launch_bounds__(block_dims_unstructured_nabla_interpol_v2c_inlined_c2v_kloop.size)
    ...
    const auto v2e = cell_index % 2 == 0 ? std::array<index_type, 18>{c2v2e_gt_ctv(cell_index, 5),
                                         ...
                                         : std::array<index_type, 18>{c2v2e_gt_ctv(cell_index, 5),
                                               ...
                                               c2v2e_gt_ctv(cell_index, 12),
                                               c2v2e_gt_ctv(cell_index, 14)};
    const auto e2c2v = cell_index % 2 == 0 ? std::array<index_type, 72>{c2v2e2c2v_gt_ctv(cell_index, 3), // 0
