...
__global__ void __launch_bounds__(block_dims_structured_nabla_interpol_v2c_inlined_naive.size)
    ...
    const std::array<index_type, 14> c2v2e2c2v_compressed{get_c2v2e2c2v_compressed(i, j, x_dim + 2 * 4)};
    const std::array<index_type, 6> c2v{get_index(i, j, x_dim),
        get_index(i, j + 1, x_dim),
        get_index(i + 1, j, x_dim),
        get_index(i + 1, j, x_dim),
        get_index(i, j + 1, x_dim),
        get_index(i + 1, j + 1, x_dim)};
    ...
    printf("s[%d %d %d:%d %d %d] c2v: %d %d %d %d %d %d\n",
        ...
        c2v[4],
        c2v[5]);
    const index_type edge_x_dim = x_dim + 2 * (halo + 1);
    const index_type edge_y_dim = y_dim + 2 * (halo + 1);
    const std::array<std::array<index_type, 6>, 6> c2v2e{
        get_v2e_per_orientation(i, j, edge_x_dim, edge_y_dim), // upward
        get_v2e_per_orientation(i, j + 1, edge_x_dim, edge_y_dim),
        get_v2e_per_orientation(i + 1, j, edge_x_dim, edge_y_dim),
        get_v2e_per_orientation(i + 1, j, edge_x_dim, edge_y_dim), // downward
        get_v2e_per_orientation(i, j + 1, edge_x_dim, edge_y_dim),
        get_v2e_per_orientation(i + 1, j + 1, edge_x_dim, edge_y_dim)};
    printf("s[%d %d %d:%d %d %d] v2e: %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d "
           "%d %d %d %d %d %d %d %d %d\n",
        blockIdx.x,
        blockIdx.y,
        blockIdx.z,
    ...
    printf("s[%d %d %d:%d %d %d] e2c2v: %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d "
        ...
        e2c2v[142],
        e2c2v[143]);
    const std::array<index_type, 144> c2v2e2ecv{c2v2e[0][0], // 0 // upward
        c2v2e[0][0] + interpolate_output_domain_size * 3,
        c2v2e[0][0] + interpolate_output_domain_size * 6,
        c2v2e[0][0] + interpolate_output_domain_size * 9,
        c2v2e[0][1],
        c2v2e[0][1] + interpolate_output_domain_size * 3,
        c2v2e[0][1] + interpolate_output_domain_size * 6,
        c2v2e[0][1] + interpolate_output_domain_size * 9,
        c2v2e[0][2],
        c2v2e[0][2] + interpolate_output_domain_size * 3,
        c2v2e[0][2] + interpolate_output_domain_size * 6,
        c2v2e[0][2] + interpolate_output_domain_size * 9,
        c2v2e[0][3],
        c2v2e[0][3] + interpolate_output_domain_size * 3,
        c2v2e[0][3] + interpolate_output_domain_size * 6,
        c2v2e[0][3] + interpolate_output_domain_size * 9,
        c2v2e[0][4],
        c2v2e[0][4] + interpolate_output_domain_size * 3,
        c2v2e[0][4] + interpolate_output_domain_size * 6,
        c2v2e[0][4] + interpolate_output_domain_size * 9,
        c2v2e[0][5],
        c2v2e[0][5] + interpolate_output_domain_size * 3,
        c2v2e[0][5] + interpolate_output_domain_size * 6,
        c2v2e[0][5] + interpolate_output_domain_size * 9,
        c2v2e[1][0], // 1
        c2v2e[1][0] + interpolate_output_domain_size * 3,
        c2v2e[1][0] + interpolate_output_domain_size * 6,
        c2v2e[1][0] + interpolate_output_domain_size * 9,
        c2v2e[1][1],
        c2v2e[1][1] + interpolate_output_domain_size * 3,
        c2v2e[1][1] + interpolate_output_domain_size * 6,
        c2v2e[1][1] + interpolate_output_domain_size * 9,
        c2v2e[1][2],
        c2v2e[1][2] + interpolate_output_domain_size * 3,
        c2v2e[1][2] + interpolate_output_domain_size * 6,
        c2v2e[1][2] + interpolate_output_domain_size * 9,
        c2v2e[1][3],
        c2v2e[1][3] + interpolate_output_domain_size * 3,
        c2v2e[1][3] + interpolate_output_domain_size * 6,
        c2v2e[1][3] + interpolate_output_domain_size * 9,
        c2v2e[1][4],
        c2v2e[1][4] + interpolate_output_domain_size * 3,
        c2v2e[1][4] + interpolate_output_domain_size * 6,
        c2v2e[1][4] + interpolate_output_domain_size * 9,
        c2v2e[1][5],
        c2v2e[1][5] + interpolate_output_domain_size * 3,
        c2v2e[1][5] + interpolate_output_domain_size * 6,
        c2v2e[1][5] + interpolate_output_domain_size * 9,
        c2v2e[2][0], // 2
        c2v2e[2][0] + interpolate_output_domain_size * 3,
        c2v2e[2][0] + interpolate_output_domain_size * 6,
        c2v2e[2][0] + interpolate_output_domain_size * 9,
        c2v2e[2][1],
        c2v2e[2][1] + interpolate_output_domain_size * 3,
        c2v2e[2][1] + interpolate_output_domain_size * 6,
        c2v2e[2][1] + interpolate_output_domain_size * 9,
        c2v2e[2][2],
        c2v2e[2][2] + interpolate_output_domain_size * 3,
        c2v2e[2][2] + interpolate_output_domain_size * 6,
        c2v2e[2][2] + interpolate_output_domain_size * 9,
        c2v2e[2][3],
        c2v2e[2][3] + interpolate_output_domain_size * 3,
        c2v2e[2][3] + interpolate_output_domain_size * 6,
        c2v2e[2][3] + interpolate_output_domain_size * 9,
        c2v2e[2][4],
        c2v2e[2][4] + interpolate_output_domain_size * 3,
        c2v2e[2][4] + interpolate_output_domain_size * 6,
        c2v2e[2][4] + interpolate_output_domain_size * 9,
        c2v2e[2][5],
        c2v2e[2][5] + interpolate_output_domain_size * 3,
        c2v2e[2][5] + interpolate_output_domain_size * 6,
        c2v2e[2][5] + interpolate_output_domain_size * 9,
        c2v2e[3][0], // 3
        c2v2e[3][0] + interpolate_output_domain_size * 3,
        c2v2e[3][0] + interpolate_output_domain_size * 6,
        c2v2e[3][0] + interpolate_output_domain_size * 9,
        c2v2e[3][1],
        c2v2e[3][1] + interpolate_output_domain_size * 3,
        c2v2e[3][1] + interpolate_output_domain_size * 6,
        c2v2e[3][1] + interpolate_output_domain_size * 9,
        c2v2e[3][2],
        c2v2e[3][2] + interpolate_output_domain_size * 3,
        c2v2e[3][2] + interpolate_output_domain_size * 6,
        c2v2e[3][2] + interpolate_output_domain_size * 9,
        c2v2e[3][3],
        c2v2e[3][3] + interpolate_output_domain_size * 3,
        c2v2e[3][3] + interpolate_output_domain_size * 6,
        c2v2e[3][3] + interpolate_output_domain_size * 9,
        c2v2e[3][4],
        c2v2e[3][4] + interpolate_output_domain_size * 3,
        c2v2e[3][4] + interpolate_output_domain_size * 6,
        c2v2e[3][4] + interpolate_output_domain_size * 9,
        c2v2e[3][5],
        c2v2e[3][5] + interpolate_output_domain_size * 3,
        c2v2e[3][5] + interpolate_output_domain_size * 6,
        c2v2e[3][5] + interpolate_output_domain_size * 9,
        c2v2e[4][0], // 4
        c2v2e[4][0] + interpolate_output_domain_size * 3,
        c2v2e[4][0] + interpolate_output_domain_size * 6,
        c2v2e[4][0] + interpolate_output_domain_size * 9,
        c2v2e[4][1],
        c2v2e[4][1] + interpolate_output_domain_size * 3,
        c2v2e[4][1] + interpolate_output_domain_size * 6,
        c2v2e[4][1] + interpolate_output_domain_size * 9,
        c2v2e[4][2],
        c2v2e[4][2] + interpolate_output_domain_size * 3,
        c2v2e[4][2] + interpolate_output_domain_size * 6,
        c2v2e[4][2] + interpolate_output_domain_size * 9,
        c2v2e[4][3],
        c2v2e[4][3] + interpolate_output_domain_size * 3,
        c2v2e[4][3] + interpolate_output_domain_size * 6,
        c2v2e[4][3] + interpolate_output_domain_size * 9,
        c2v2e[4][4],
        c2v2e[4][4] + interpolate_output_domain_size * 3,
        c2v2e[4][4] + interpolate_output_domain_size * 6,
        c2v2e[4][4] + interpolate_output_domain_size * 9,
        c2v2e[4][5],
        c2v2e[4][5] + interpolate_output_domain_size * 3,
        c2v2e[4][5] + interpolate_output_domain_size * 6,
        c2v2e[4][5] + interpolate_output_domain_size * 9,
        c2v2e[5][0], // 5
        c2v2e[5][0] + interpolate_output_domain_size * 3,
        c2v2e[5][0] + interpolate_output_domain_size * 6,
        c2v2e[5][0] + interpolate_output_domain_size * 9,
        c2v2e[5][1],
        c2v2e[5][1] + interpolate_output_domain_size * 3,
        c2v2e[5][1] + interpolate_output_domain_size * 6,
        c2v2e[5][1] + interpolate_output_domain_size * 9,
        c2v2e[5][2],
        c2v2e[5][2] + interpolate_output_domain_size * 3,
        c2v2e[5][2] + interpolate_output_domain_size * 6,
        c2v2e[5][2] + interpolate_output_domain_size * 9,
        c2v2e[5][3],
        c2v2e[5][3] + interpolate_output_domain_size * 3,
        c2v2e[5][3] + interpolate_output_domain_size * 6,
        c2v2e[5][3] + interpolate_output_domain_size * 9,
        c2v2e[5][4],
        c2v2e[5][4] + interpolate_output_domain_size * 3,
        c2v2e[5][4] + interpolate_output_domain_size * 6,
        c2v2e[5][4] + interpolate_output_domain_size * 9,
        c2v2e[5][5],
        c2v2e[5][5] + interpolate_output_domain_size * 3,
        c2v2e[5][5] + interpolate_output_domain_size * 6,
        c2v2e[5][5] + interpolate_output_domain_size * 9};
...
#pragma unroll 36
    for (int edge_index{}; edge_index < 36; ++edge_index) {
        ...
        const index_type edge_id{c2v2e[edge_index / 6][edge_index % 6]};
...
#pragma unroll 6
    ...
    p_cell_out_gt_tv(cell_index_internal_downward, k_index) =
        (p_u_out[0] * ptr_c_coeff_1_gt_ctv(cell_index_internal_downward, 0) +
            p_u_out[1] * ptr_c_coeff_1_gt_ctv(cell_index_internal_downward, 1) +
            p_u_out[2] * ptr_c_coeff_1_gt_ctv(cell_index_internal_downward, 2) +
            p_v_out[0] * ptr_c_coeff_2_gt_ctv(cell_index_internal_downward, 0) +
            p_v_out[1] * ptr_c_coeff_2_gt_ctv(cell_index_internal_downward, 1) +
            p_v_out[2] * ptr_c_coeff_2_gt_ctv(cell_index_internal_downward, 2)) /
        2;
};
