...
constexpr block_dims block_dims_unstructured_verts2cells_kloop = get_block_dims_unstructured_verts2cells_kloop<index_type>();
...
__global__ void __launch_bounds__(block_dims_unstructured_verts2cells_kloop.size)
    ...
    const WP_TYPE coeff[3]{ptr_coeff_gt_ctv(cell_index, 0), ptr_coeff_gt_ctv(cell_index, 1), ptr_coeff_gt_ctv(cell_index, 2)};
