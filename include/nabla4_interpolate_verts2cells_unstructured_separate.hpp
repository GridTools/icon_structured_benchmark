...
template <typename T>
struct nabla4_interpolate_verts2cells_unstructured_separate {
  ...
  public:
    nabla4_interpolate_verts2cells_unstructured_separate(const std::vector<std::array<index_type, 4>> &e2c2v,
