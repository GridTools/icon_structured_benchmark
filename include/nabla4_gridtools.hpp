...
struct nabla4_gt_data {
    ...
    const data_store_2d_chv_VP_t u_vert_gt_hv;
    const data_store_2d_chv_VP_t v_vert_gt_hv;
    const data_store_1d_chv_WP_t primal_normal_vert_v1_gt_hv;
    const data_store_1d_chv_WP_t primal_normal_vert_v2_gt_hv;
    const data_store_2d_chv_WP_t z_nabla2_e_gt_hv;
    const data_store_1d_chv_WP_t inv_vert_vert_length_gt_hv;
    const data_store_1d_chv_WP_t inv_primal_edge_length_gt_hv;
