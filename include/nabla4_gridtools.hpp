...
struct nabla4_gt_data {
    ...
    nabla4_gt_data(std::size_t CellDim, std::size_t VertexDim, std::size_t EdgeDim, std::size_t KDim, std::size_t ECVDim, std::size_t output_size, const std::vector<std::vector<VP_TYPE>> &u_vert,
