...
class nabla4_structured_torus : private nabla4_data<T> {
  ...
  public:
    ...
    inline void inner_kernel_ifirst(
        ...
        auto u_vert_gt_tv = u_vert_gt->target_view();
        auto v_vert_gt_tv = v_vert_gt->target_view();
        auto primal_normal_vert_v1_gt_tv = primal_normal_vert_v1_gt->target_view();
        auto primal_normal_vert_v2_gt_tv = primal_normal_vert_v2_gt->target_view();
        auto z_nabla2_e_gt_tv = z_nabla2_e_gt->target_view();
        auto inv_vert_vert_length_gt_tv = inv_vert_vert_length_gt->target_view();
        auto inv_primal_edge_length_gt_tv = inv_primal_edge_length_gt->target_view();
        auto z_nabla4_e2_wp_gt_tv = z_nabla4_e2_wp_gt->target_view();
