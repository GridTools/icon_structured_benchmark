...
def test_validate_nabla4_unstructured_cpu_kfirst_pragma(request, grid):
    grid = request.getfixturevalue(grid)
    z_nabla4_e2_comp = icon_benchmark.nabla4_validate_unstructured_cpu_kfirst_pragma(
        grid.e2c2v,
        grid.e2ecv,
        grid.num_cells,
        grid.num_vertices,
...
def test_validate_nabla4_unstructured_cpu_kfirst_simd(request, grid):
    grid = request.getfixturevalue(grid)
    z_nabla4_e2_comp = icon_benchmark.nabla4_validate_unstructured_cpu_kfirst_simd(
        grid.e2c2v,
        grid.e2ecv,
        grid.num_cells,
        grid.num_vertices,
...
def test_validate_nabla4_unstructured_simd_cpu_kfirst_simd(request, grid):
    grid = request.getfixturevalue(grid)
    z_nabla4_e2_comp = icon_benchmark.nabla4_validate_unstructured_simd_cpu_kfirst_simd(
        grid.e2c2v,
        grid.e2ecv,
        grid.num_cells,
        grid.num_vertices,
...
def test_validate_nabla4_unstructured_cpu_ifirst_gridtools(request, grid):
    grid = request.getfixturevalue(grid)
    z_nabla4_e2_comp = icon_benchmark.nabla4_validate_unstructured_cpu_kfirst_gridtools(
        grid.e2c2v,
        grid.e2ecv,
        grid.num_cells,
        grid.num_vertices,
...
def test_validate_nabla4_unstructured_cpu_kfirst_gridtools(request, grid):
    grid = request.getfixturevalue(grid)
    z_nabla4_e2_comp = icon_benchmark.nabla4_validate_unstructured_cpu_kfirst_gridtools(
        grid.e2c2v,
        grid.e2ecv,
