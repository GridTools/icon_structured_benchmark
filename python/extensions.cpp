...
NB_MODULE(icon_benchmark, m) {
    ...
    m.def("nabla4_benchmark_unstructured_gpu_kloop_cutile", &nabla4_benchmark_unstructured_gpu_kloop_cutile);
    m.def("nabla4_benchmark_unstructured_gpu_naive_cutile", &nabla4_benchmark_unstructured_gpu_naive_cutile);
    ...
    m.def("nabla4_validate_unstructured_gpu_kloop_cutile", &nabla4_validate_unstructured_gpu_kloop_cutile);
    m.def("nabla4_validate_unstructured_gpu_naive_cutile", &nabla4_validate_unstructured_gpu_naive_cutile);
    /// Structured
    ...
    m.def("nabla4_benchmark_structured_torus_gpu_kloop_cutile_halo",
        &nabla4_benchmark_structured_torus_gpu_kloop_cutile_halo);
    m.def("nabla4_benchmark_structured_torus_gpu_naive_cutile_halo",
    ...
    m.def("nabla4_validate_structured_torus_gpu_kloop_cutile_halo",
        &nabla4_validate_structured_torus_gpu_kloop_cutile_halo);
    m.def("nabla4_validate_structured_torus_gpu_naive_cutile_halo",
        &nabla4_validate_structured_torus_gpu_naive_cutile_halo);
    ...
    m.def("nabla4_interpolate_inlined_v2v_verts2cells_validate_unstructured_gpu_naive_separate",
        &nabla4_interpolate_inlined_v2v_verts2cells_validate_unstructured_gpu_naive_separate);
    ...
    m.def("nabla4_interpolate_inlined_v2v_verts2cells_validate_unstructured_gpu_kloop_separate",
        &nabla4_interpolate_inlined_v2v_verts2cells_validate_unstructured_gpu_kloop_separate);
    ...
    m.def("nabla4_interpolate_verts2cells_validate_structured_gpu_kloop_inlined_cached_pipeline",
        &nabla4_interpolate_verts2cells_validate_structured_gpu_kloop_inlined_cached_pipeline);
    ...
    m.def("nabla4_interpolate_inlined_v2v_verts2cells_benchmark_unstructured_gpu_naive_separate",
    ...
    m.def("nabla4_interpolate_inlined_v2v_verts2cells_benchmark_unstructured_gpu_kloop_separate",
    ...
    m.def("nabla4_interpolate_verts2cells_benchmark_structured_gpu_kloop_inlined_cached_pipeline",
