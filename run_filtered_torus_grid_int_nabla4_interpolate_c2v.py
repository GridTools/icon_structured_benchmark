...
def run_sanity_checks(
    ...
    if backend in ["all_gpu", "gpu_naive"]:
        if combination in ["all", "separate"]:
            ...
            print(
                "Running structured gpu_naive nabla4_interpolate_inlined separate sanity check"
            )
            p_cell_out_structured_gpu_naive_inlined_separate = icon_benchmark.nabla4_interpolate_inlined_verts2cells_validate_structured_gpu_naive_separate(
                random_validation_data_separate.CellDim,
                random_validation_data_separate.VertexDim,
                random_validation_data_separate.EdgeDim,
                random_validation_data_separate.KDim,
            ...
            assert np.allclose(
                p_cell_out_structured_gpu_naive_inlined_separate, p_cell_out_ref
            )
            print(
                "structured gpu_naive nabla4_interpolate_inlined separate sanity check passed"
            )

            print("Running unstructured gpu_naive inlined_v2v_separate sanity check")
            p_cell_out_unstructured_gpu_naive_inlined_v2v_separate = icon_benchmark.nabla4_interpolate_inlined_v2v_verts2cells_validate_unstructured_gpu_naive_separate(
                filtered_e2c2v_inlined,
                filtered_e2ecv_inlined,
                filtered_v2e_inlined,
                filtered_c2v_inlined,
            ...
            assert np.allclose(
                p_cell_out_unstructured_gpu_naive_inlined_v2v_separate, p_cell_out_ref
            )
            print("unstructured gpu_naive inlined_v2v_separate sanity check passed")
        ...
        if combination in ["all", "inlined"]:
            ...
            print("Running unstructured gpu_naive inlined_c2v sanity check")
            p_cell_out_unstructured_gpu_naive_inlined_c2v = icon_benchmark.nabla4_interpolate_verts2cells_validate_unstructured_gpu_naive_inlined_c2v(
                filtered_e2c2v_inlined,
                filtered_e2ecv_inlined,
                filtered_v2e_inlined,
                filtered_c2v_inlined,
            ...
            assert np.allclose(
                p_cell_out_unstructured_gpu_naive_inlined_c2v, p_cell_out_ref
            )
            print("unstructured gpu_naive inlined_c2v sanity check passed")
            ...
            print("Running structured gpu_naive inlined_cached sanity check")
            p_cell_out_structured_gpu_naive_inlined_cached = icon_benchmark.nabla4_interpolate_verts2cells_validate_structured_gpu_naive_inlined_cached(
                random_validation_data_separate.CellDim,
                random_validation_data_separate.VertexDim,
                random_validation_data_separate.EdgeDim,
                random_validation_data_separate.KDim,
            ...
            assert np.allclose(
                p_cell_out_structured_gpu_naive_inlined_cached, p_cell_out_ref
            )
            print("structured gpu_naive inlined_cached sanity check passed")
    ...
    if backend in ["all_gpu", "gpu_kloop"]:
        if combination in ["all", "separate"]:
            ...
            print(
                "Running structured gpu_kloop nabla4_interpolate_inlined separate sanity check"
            )
            p_cell_out_structured_gpu_kloop_inlined_separate = icon_benchmark.nabla4_interpolate_inlined_verts2cells_validate_structured_gpu_kloop_separate(
                random_validation_data_separate.CellDim,
                random_validation_data_separate.VertexDim,
                random_validation_data_separate.EdgeDim,
                random_validation_data_separate.KDim,
            ...
            assert np.allclose(
                p_cell_out_structured_gpu_kloop_inlined_separate, p_cell_out_ref
            )
            print(
                "structured gpu_kloop nabla4_interpolate_inlined separate sanity check passed"
            )

            print("Running unstructured gpu_kloop inlined_v2v_separate sanity check")
            p_cell_out_unstructured_gpu_kloop_inlined_v2v_separate = icon_benchmark.nabla4_interpolate_inlined_v2v_verts2cells_validate_unstructured_gpu_kloop_separate(
                filtered_e2c2v_inlined,
                filtered_e2ecv_inlined,
                filtered_v2e_inlined,
                filtered_c2v_inlined,
            ...
            assert np.allclose(
                p_cell_out_unstructured_gpu_kloop_inlined_v2v_separate, p_cell_out_ref
            )
            print("unstructured gpu_kloop inlined_v2v_separate sanity check passed")
        ...
        if combination in ["all", "inlined"]:
            ...
            print("Running unstructured gpu_kloop inlined_c2v sanity check")
            p_cell_out_unstructured_gpu_kloop_inlined_c2v = icon_benchmark.nabla4_interpolate_verts2cells_validate_unstructured_gpu_kloop_inlined_c2v(
                filtered_e2c2v_inlined,
                filtered_e2ecv_inlined,
                filtered_v2e_inlined,
                filtered_c2v_inlined,
            ...
            assert np.allclose(
                p_cell_out_unstructured_gpu_kloop_inlined_c2v, p_cell_out_ref
            )
            print("unstructured gpu_kloop inlined_c2v sanity check passed")

            print("Running structured gpu_kloop inlined sanity check")
            p_cell_out_structured_gpu_kloop_inlined = icon_benchmark.nabla4_interpolate_verts2cells_validate_structured_gpu_kloop_inlined(
                random_validation_data_separate.CellDim,
                random_validation_data_separate.VertexDim,
                random_validation_data_separate.EdgeDim,
                random_validation_data_separate.KDim,
            ...
            assert np.allclose(p_cell_out_structured_gpu_kloop_inlined, p_cell_out_ref)
            print("structured gpu_kloop inlined sanity check passed")

            print("Running structured gpu_kloop inlined_cached sanity check")
            p_cell_out_structured_gpu_kloop_inlined_cached = icon_benchmark.nabla4_interpolate_verts2cells_validate_structured_gpu_kloop_inlined_cached(
                random_validation_data_separate.CellDim,
                random_validation_data_separate.VertexDim,
                random_validation_data_separate.EdgeDim,
                random_validation_data_separate.KDim,
            ...
            assert np.allclose(
                p_cell_out_structured_gpu_kloop_inlined_cached, p_cell_out_ref
            )
            print("structured gpu_kloop inlined_cached sanity check passed")

            print("Running structured gpu_kloop inlined_cached_pipeline sanity check")
            p_cell_out_structured_gpu_kloop_inlined_cached_pipeline = icon_benchmark.nabla4_interpolate_verts2cells_validate_structured_gpu_kloop_inlined_cached_pipeline(
                random_validation_data_separate.CellDim,
                random_validation_data_separate.VertexDim,
                random_validation_data_separate.EdgeDim,
                random_validation_data_separate.KDim,
            ...
            assert np.allclose(
                p_cell_out_structured_gpu_kloop_inlined_cached_pipeline, p_cell_out_ref
            )
            print("structured gpu_kloop inlined_cached_pipeline sanity check passed")
...
def run_benchmarks():
    ...
    if args.backend in ["all_gpu", "gpu_naive"]:
        if args.combination in ["all", "separate"]:
            ...
            ] = icon_benchmark.nabla4_interpolate_inlined_verts2cells_benchmark_structured_gpu_naive_separate(
                torus_grid.num_cells,
                torus_grid.num_vertices,
                torus_grid.num_edges,
                torus_grid.num_levels,
            ...
            print(
                "nabla4_interpolate_inlined_verts2cells_benchmark_structured_gpu_naive_separate median: {}".format(
                    np.median(
                        runtimes[
                            "nabla4_interpolate_inlined_verts2cells_benchmark_structured_gpu_naive_separate"
                        ]
            ...
            runtimes[
                "nabla4_interpolate_inlined_v2v_verts2cells_benchmark_unstructured_gpu_naive_separate"
            ] = icon_benchmark.nabla4_interpolate_inlined_v2v_verts2cells_benchmark_unstructured_gpu_naive_separate(
                filtered_e2c2v_inlined,
                filtered_e2ecv_inlined,
                filtered_v2e_inlined,
                filtered_c2v,
            ...
            print(
                "nabla4_interpolate_inlined_v2v_verts2cells_benchmark_unstructured_gpu_naive_separate median: {}".format(
                    np.median(
                        runtimes[
                            "nabla4_interpolate_inlined_v2v_verts2cells_benchmark_unstructured_gpu_naive_separate"
                        ]
        ...
        if args.combination in ["all", "inlined"]:
            ...
            ] = icon_benchmark.nabla4_interpolate_verts2cells_benchmark_unstructured_gpu_naive_inlined_c2v(
                filtered_e2c2v_inlined,
                filtered_e2ecv_inlined,
                filtered_v2e_inlined,
                filtered_c2v,
            ...
            print(
                "nabla4_interpolate_verts2cells_benchmark_unstructured_gpu_naive_inlined_c2v median: {}".format(
                    np.median(
                        runtimes[
                            "nabla4_interpolate_verts2cells_benchmark_unstructured_gpu_naive_inlined_c2v"
                        ]
            ...
            ] = icon_benchmark.nabla4_interpolate_verts2cells_benchmark_structured_gpu_naive_inlined_cached(
                torus_grid.num_cells,
                torus_grid.num_vertices,
                torus_grid.num_edges,
                torus_grid.num_levels,
            ...
            print(
                "nabla4_interpolate_verts2cells_benchmark_structured_gpu_naive_inlined_cached median: {}".format(
                    np.median(
                        runtimes[
                            "nabla4_interpolate_verts2cells_benchmark_structured_gpu_naive_inlined_cached"
                        ]
    ...
    if args.backend in ["all_gpu", "gpu_kloop"]:
        if args.combination in ["all", "separate"]:
            ...
            ] = icon_benchmark.nabla4_interpolate_inlined_verts2cells_benchmark_structured_gpu_kloop_separate(
                torus_grid.num_cells,
                torus_grid.num_vertices,
                torus_grid.num_edges,
                torus_grid.num_levels,
            ...
            print(
                "nabla4_interpolate_inlined_verts2cells_benchmark_structured_gpu_kloop_separate median: {}".format(
                    np.median(
                        runtimes[
                            "nabla4_interpolate_inlined_verts2cells_benchmark_structured_gpu_kloop_separate"
                        ]
            ...
            runtimes[
                "nabla4_interpolate_inlined_v2v_verts2cells_benchmark_unstructured_gpu_kloop_separate"
            ] = icon_benchmark.nabla4_interpolate_inlined_v2v_verts2cells_benchmark_unstructured_gpu_kloop_separate(
                filtered_e2c2v_inlined,
                filtered_e2ecv_inlined,
                filtered_v2e_inlined,
                filtered_c2v,
            ...
            print(
                "nabla4_interpolate_inlined_v2v_verts2cells_benchmark_unstructured_gpu_kloop_separate median: {}".format(
                    np.median(
                        runtimes[
                            "nabla4_interpolate_inlined_v2v_verts2cells_benchmark_unstructured_gpu_kloop_separate"
                        ]
        ...
        if args.combination in ["all", "inlined"]:
            ...
            ] = icon_benchmark.nabla4_interpolate_verts2cells_benchmark_unstructured_gpu_kloop_inlined_c2v(
                filtered_e2c2v_inlined,
                filtered_e2ecv_inlined,
                filtered_v2e_inlined,
                filtered_c2v,
            ...
            print(
                "nabla4_interpolate_verts2cells_benchmark_unstructured_gpu_kloop_inlined_c2v median: {}".format(
                    np.median(
                        runtimes[
                            "nabla4_interpolate_verts2cells_benchmark_unstructured_gpu_kloop_inlined_c2v"
                        ]
            ...
            ] = icon_benchmark.nabla4_interpolate_verts2cells_benchmark_structured_gpu_kloop_inlined(
                torus_grid.num_cells,
                torus_grid.num_vertices,
                torus_grid.num_edges,
                torus_grid.num_levels,
            ...
            print(
                "nabla4_interpolate_verts2cells_benchmark_structured_gpu_kloop_inlined median: {}".format(
                    np.median(
                        runtimes[
                            "nabla4_interpolate_verts2cells_benchmark_structured_gpu_kloop_inlined"
                        ]
            ...
            ] = icon_benchmark.nabla4_interpolate_verts2cells_benchmark_structured_gpu_kloop_inlined_cached(
                torus_grid.num_cells,
                torus_grid.num_vertices,
                torus_grid.num_edges,
                torus_grid.num_levels,
            ...
            print(
                "nabla4_interpolate_verts2cells_benchmark_structured_gpu_kloop_inlined_cached median: {}".format(
                    np.median(
                        runtimes[
                            "nabla4_interpolate_verts2cells_benchmark_structured_gpu_kloop_inlined_cached"
                        ]
            ...
            runtimes[
                "nabla4_interpolate_verts2cells_benchmark_structured_gpu_kloop_inlined_cached_pipeline"
            ] = icon_benchmark.nabla4_interpolate_verts2cells_benchmark_structured_gpu_kloop_inlined_cached_pipeline(
                torus_grid.num_cells,
                torus_grid.num_vertices,
                torus_grid.num_edges,
                torus_grid.num_levels,
            ...
            print(
                "nabla4_interpolate_verts2cells_benchmark_structured_gpu_kloop_inlined_cached_pipeline median: {}".format(
                    np.median(
                        runtimes[
                            "nabla4_interpolate_verts2cells_benchmark_structured_gpu_kloop_inlined_cached_pipeline"
                        ]
