...
if __name__ == "__main__":
    ...
    runtimes_output = read_torus_results_commit_backend_index_type(
        "results/interpolate_output_{}_{}_{}".format(git_commit, backend, index_type),
        torus_files,
        klevels,
        git_commit,
        backend,
    ...
    output_directory = "results/plot_interpolate_output_halo_{}_{}_{}".format(
    ...
    for torus_size, runtime_data in runtimes_output.items():
        for k in runtime_data.keys():
            ...
            runtime_data[k] = {
                "interpolate_benchmark_unstructured_gpu_naive": runtime_data[k][
                    "interpolate_benchmark_unstructured_gpu_naive"
                ],
