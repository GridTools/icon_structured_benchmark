...
std::vector<double> nabla4_interpolate_inlined_v2v_verts2cells_benchmark_unstructured_gpu_naive_separate(
    const std::vector<std::array<index_type, 4>> &e2c2v,
    const std::vector<std::array<index_type, 4>> &e2ecv,
    const std::vector<std::array<index_type, 6>> &v2e,
    const std::vector<std::array<index_type, 3>> &c2v,
    ...
    int repetitions,
    int dry_runs) {
    return benchmark_gridtools<gpu_naive, nabla4_interpolate_inlined_v2v_verts2cells_unstructured_separate>(
        std::make_tuple(e2c2v, e2ecv, v2e, c2v, CellDim, VertexDim, EdgeDim, KDim, ECVDim), repetitions, dry_runs);
}
...
std::vector<double> nabla4_interpolate_inlined_verts2cells_benchmark_structured_gpu_naive_separate(index_type CellDim,
    ...
    int repetitions,
    int dry_runs) {
    return benchmark_gridtools<gpu_naive, nabla4_interpolate_inlined_verts2cells_structured_separate>(
        std::make_tuple(CellDim, VertexDim, EdgeDim, KDim, ECVDim, longitude_dim, latitude_dim, halo),
        repetitions,
        dry_runs);
}
...
std::vector<double> nabla4_interpolate_verts2cells_benchmark_structured_gpu_naive_inlined_cached(index_type CellDim,
    ...
    int repetitions,
    int dry_runs) {
    return benchmark_gridtools<gpu_naive, nabla4_interpolate_verts2cells_structured_inlined_cached>(
        std::make_tuple(CellDim, VertexDim, EdgeDim, KDim, ECVDim, longitude_dim, latitude_dim, halo),
        repetitions,
        dry_runs);
}
...
std::vector<double> nabla4_interpolate_inlined_v2v_verts2cells_benchmark_unstructured_gpu_kloop_separate(
    const std::vector<std::array<index_type, 4>> &e2c2v,
    const std::vector<std::array<index_type, 4>> &e2ecv,
    const std::vector<std::array<index_type, 6>> &v2e,
    const std::vector<std::array<index_type, 3>> &c2v,
    ...
    int repetitions,
    int dry_runs) {
    return benchmark_gridtools<gpu_kloop, nabla4_interpolate_inlined_v2v_verts2cells_unstructured_separate>(
        std::make_tuple(e2c2v, e2ecv, v2e, c2v, CellDim, VertexDim, EdgeDim, KDim, ECVDim), repetitions, dry_runs);
}
...
std::vector<double> nabla4_interpolate_inlined_verts2cells_benchmark_structured_gpu_kloop_separate(index_type CellDim,
    ...
    int repetitions,
    int dry_runs) {
    return benchmark_gridtools<gpu_kloop, nabla4_interpolate_inlined_verts2cells_structured_separate>(
        std::make_tuple(CellDim, VertexDim, EdgeDim, KDim, ECVDim, longitude_dim, latitude_dim, halo),
        repetitions,
        dry_runs);
}
...
std::vector<double> nabla4_interpolate_verts2cells_benchmark_structured_gpu_kloop_inlined_cached(index_type CellDim,
    ...
    int repetitions,
    int dry_runs) {
    return benchmark_gridtools<gpu_kloop, nabla4_interpolate_verts2cells_structured_inlined_cached>(
        std::make_tuple(CellDim, VertexDim, EdgeDim, KDim, ECVDim, longitude_dim, latitude_dim, halo),
        repetitions,
        dry_runs);
}
...
std::vector<std::vector<WP_TYPE>> nabla4_interpolate_inlined_v2v_verts2cells_validate_unstructured_gpu_naive_separate(
    const std::vector<std::array<index_type, 4>> &e2c2v,
    const std::vector<std::array<index_type, 4>> &e2ecv,
    const std::vector<std::array<index_type, 6>> &v2e,
    const std::vector<std::array<index_type, 3>> &c2v,
    ...
    const std::vector<std::vector<WP_TYPE>> &ptr_c_coeff_1,
    const std::vector<std::vector<WP_TYPE>> &ptr_c_coeff_2) {
    return verts2cells_validate_gridtools<gpu_naive, nabla4_interpolate_inlined_v2v_verts2cells_unstructured_separate>(
        std::make_tuple(e2c2v,
            e2ecv,
            v2e,
            c2v,
...
std::vector<std::vector<WP_TYPE>> nabla4_interpolate_inlined_verts2cells_validate_structured_gpu_naive_separate(
    ...
    const std::vector<std::vector<WP_TYPE>> &ptr_c_coeff_1,
    const std::vector<std::vector<WP_TYPE>> &ptr_c_coeff_2) {
    return verts2cells_validate_gridtools<gpu_naive, nabla4_interpolate_inlined_verts2cells_structured_separate>(
        std::make_tuple(CellDim,
            VertexDim,
            EdgeDim,
            KDim,
...
std::vector<std::vector<WP_TYPE>> nabla4_interpolate_verts2cells_validate_structured_gpu_naive_inlined_cached(
    ...
    const std::vector<std::vector<WP_TYPE>> &ptr_c_coeff_1,
    const std::vector<std::vector<WP_TYPE>> &ptr_c_coeff_2) {
    return verts2cells_validate_gridtools<gpu_naive, nabla4_interpolate_verts2cells_structured_inlined_cached>(
        std::make_tuple(CellDim,
            VertexDim,
            EdgeDim,
            KDim,
...
std::vector<std::vector<WP_TYPE>> nabla4_interpolate_inlined_v2v_verts2cells_validate_unstructured_gpu_kloop_separate(
    const std::vector<std::array<index_type, 4>> &e2c2v,
    const std::vector<std::array<index_type, 4>> &e2ecv,
    const std::vector<std::array<index_type, 6>> &v2e,
    const std::vector<std::array<index_type, 3>> &c2v,
    ...
    const std::vector<std::vector<WP_TYPE>> &ptr_c_coeff_1,
    const std::vector<std::vector<WP_TYPE>> &ptr_c_coeff_2) {
    return verts2cells_validate_gridtools<gpu_kloop, nabla4_interpolate_inlined_v2v_verts2cells_unstructured_separate>(
        std::make_tuple(e2c2v,
            e2ecv,
            v2e,
            c2v,
...
std::vector<std::vector<WP_TYPE>> nabla4_interpolate_inlined_verts2cells_validate_structured_gpu_kloop_separate(
    ...
    const std::vector<std::vector<WP_TYPE>> &ptr_c_coeff_1,
    const std::vector<std::vector<WP_TYPE>> &ptr_c_coeff_2) {
    return verts2cells_validate_gridtools<gpu_kloop, nabla4_interpolate_inlined_verts2cells_structured_separate>(
        std::make_tuple(CellDim,
            VertexDim,
            EdgeDim,
            KDim,
...
std::vector<std::vector<WP_TYPE>> nabla4_interpolate_verts2cells_validate_structured_gpu_kloop_inlined_cached(
    ...
    const std::vector<std::vector<WP_TYPE>> &ptr_c_coeff_1,
    const std::vector<std::vector<WP_TYPE>> &ptr_c_coeff_2) {
    return verts2cells_validate_gridtools<gpu_kloop, nabla4_interpolate_verts2cells_structured_inlined_cached>(
        std::make_tuple(CellDim,
            VertexDim,
            EdgeDim,
            KDim,
