...
std::vector<double> nabla4_benchmark_structured_torus_gpu_kloop_gridtools_halo_pipeline(index_type CellDim,
    ...
    int repetitions,
    int dry_runs) {
    return benchmark_gridtools<gpu_kloop, nabla4_structured_torus_halo_gt_pipeline>(
        std::make_tuple(CellDim, VertexDim, EdgeDim, KDim, ECVDim, longitude_dim, latitude_dim, halo),
        repetitions,
        dry_runs);
}
...
std::vector<std::vector<VP_TYPE>> nabla4_validate_structured_torus_gpu_kloop_gridtools_halo_pipeline(index_type CellDim,
    ...
    std::vector<WP_TYPE> &inv_vert_vert_length,
    std::vector<WP_TYPE> &inv_primal_edge_length) {
    return nabla4_validate_gridtools<gpu_kloop, nabla4_structured_torus_halo_gt_pipeline>(std::make_tuple(CellDim,
        VertexDim,
        EdgeDim,
        KDim,
        ECVDim,
...
std::vector<double> nabla4_interpolate_benchmark_structured_gpu_kloop_inlined_pipeline(index_type CellDim,
    ...
    int repetitions,
    int dry_runs) {
    return benchmark_gridtools<gpu_kloop, nabla4_interpolate_structured_inlined_pipeline>(
        std::make_tuple(CellDim, VertexDim, EdgeDim, KDim, ECVDim, longitude_dim, latitude_dim, halo),
        repetitions,
        dry_runs);
}
...
std::pair<std::vector<std::vector<WP_TYPE>>, std::vector<std::vector<WP_TYPE>>>
nabla4_vertical_interpolate_validate_unstructured_gpu_naive_separate(std::vector<std::array<index_type, 4>> &e2c2v,
    std::vector<std::array<index_type, 4>> &e2ecv,
    std::vector<std::array<index_type, 6>> &v2e,
    index_type CellDim,
    index_type VertexDim,
...
std::pair<std::vector<std::vector<WP_TYPE>>, std::vector<std::vector<WP_TYPE>>>
nabla4_vertical_interpolate_validate_unstructured_gpu_naive_inlined(std::vector<std::array<index_type, 4>> &e2c2v,
    std::vector<std::array<index_type, 4>> &e2ecv,
    std::vector<std::array<index_type, 6>> &v2e,
    index_type CellDim,
    index_type VertexDim,
...
std::pair<std::vector<std::vector<WP_TYPE>>, std::vector<std::vector<WP_TYPE>>>
nabla4_vertical_interpolate_validate_unstructured_gpu_naive_inlined_v2v(std::vector<std::array<index_type, 4>> &e2c2v,
    std::vector<std::array<index_type, 4>> &e2ecv,
    std::vector<std::array<index_type, 6>> &v2e,
    index_type CellDim,
    index_type VertexDim,
...
std::pair<std::vector<std::vector<WP_TYPE>>, std::vector<std::vector<WP_TYPE>>>
nabla4_vertical_interpolate_validate_unstructured_gpu_kloop_separate(std::vector<std::array<index_type, 4>> &e2c2v,
    std::vector<std::array<index_type, 4>> &e2ecv,
    std::vector<std::array<index_type, 6>> &v2e,
    index_type CellDim,
    index_type VertexDim,
...
std::pair<std::vector<std::vector<WP_TYPE>>, std::vector<std::vector<WP_TYPE>>>
nabla4_interpolate_validate_unstructured_gpu_kloop_inlined_cached(std::vector<std::array<index_type, 4>> &e2c2v,
    std::vector<std::array<index_type, 4>> &e2ecv,
    std::vector<std::array<index_type, 6>> &v2e,
    index_type CellDim,
    index_type VertexDim,
...
std::pair<std::vector<std::vector<WP_TYPE>>, std::vector<std::vector<WP_TYPE>>>
nabla4_vertical_interpolate_validate_unstructured_gpu_kloop_inlined(std::vector<std::array<index_type, 4>> &e2c2v,
    std::vector<std::array<index_type, 4>> &e2ecv,
    std::vector<std::array<index_type, 6>> &v2e,
    index_type CellDim,
    index_type VertexDim,
...
std::pair<std::vector<std::vector<WP_TYPE>>, std::vector<std::vector<WP_TYPE>>>
nabla4_vertical_interpolate_validate_unstructured_gpu_kloop_inlined_v2v(std::vector<std::array<index_type, 4>> &e2c2v,
    std::vector<std::array<index_type, 4>> &e2ecv,
    std::vector<std::array<index_type, 6>> &v2e,
    index_type CellDim,
    index_type VertexDim,
...
nabla4_interpolate_validate_structured_gpu_kloop_inlined_pipeline(index_type CellDim,
    ...
    std::vector<std::vector<WP_TYPE>> &ptr_coeff_1,
    std::vector<std::vector<WP_TYPE>> &ptr_coeff_2) {
    return interpolate_validate_gridtools<gpu_kloop, nabla4_interpolate_structured_inlined_pipeline>(
        std::make_tuple(CellDim,
            VertexDim,
            EdgeDim,
            KDim,
